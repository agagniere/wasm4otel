...
func newRuntime(context std_context.Context) wazy.Runtime {
	runtime := wazy.NewRuntimeWithConfig(context, wazy.NewRuntimeConfigInterpreter())
...
// buffer. Holds callMu for the whole sequence — wazy modules are
